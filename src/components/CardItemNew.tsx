...
const CardItemNew: React.FC<TCartItem> = ({id,title,price,brand,image}) => {
      ...
      <div className="cart__order">
        <div className="cart__column">
          <div className="cart__item">
            ...
            <div className="cart__info">
              ...
              <div className="cart__size">Brand: {brand}</div>
        ...
        <div className="cart__column">
          <div className="cart__block">
            <button aria-label="trashBtn" className="cart__trashbin" >
              <svg
                width="25"
                height="25"
                viewBox="0 0 25 25"
