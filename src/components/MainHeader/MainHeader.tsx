...
const MainHeader: React.FC = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (!(event.target as HTMLElement).closest(".signup")) {
        // Clicked outside the div, perform the desired action here
        ...
        <nav className="header__menu menu">
          <ul className={screenWidth > 992 || !isMobile ? 'menu__list' : 'menu__list_mobile'}>
            ...
            <li className="menu__link">
              ...
              >
                <path
                  d="M12.5 0C5.60265 0 0 5.60265 0 12.5C0 19.3974 5.60265 25 12.5 25C19.3974 25 25 19.3974 25 12.5C25 5.60265 19.3974 0 12.5 0ZM12.5 23.4375C6.82628 23.4375 1.5625 18.1737 1.5625 12.5C1.5625 6.82628 6.82628 1.5625 12.5 1.5625C18.1737 1.5625 23.4375 6.82628 23.4375 12.5C23.4375 18.1737 18.1737 23.4375 12.5 23.4375ZM14.3819 10.3406C14.7234 9.99915 14.7234 9.44247 14.3819 9.10102C14.0404 8.75958 13.4837 8.75958 13.1422 9.10102L9.84906 12.3941C9.50762 12.7356 9.50762 13.2923 9.84906 13.6337L13.1422 16.9269C13.4837 17.2683 14.0404 17.2683 14.3819 16.9269C14.7234 16.5855 14.7234 16.0288 14.3819 15.6873L11.7452 13.0507L14.3819 10.3406Z"
                  fill="white"
                />
              </svg>
              </Link>
